...
parser.add_argument('--seed', type=int, default=12356, metavar='N',
...
parser.add_argument('--horizon', type=int, default=10, 
                    help='checkpoint training model every # steps')
parser.add_argument('--fixed_horizon', type=bool, default=True, 
                    help='if False sample between [0, horizon]')
parser.add_argument('--start_horizon', type=int, default=10, 
                    help='checkpoint training model every # steps')
parser.add_argument('--end_horizon', type=int, default=10, 
                    help='checkpoint training model every # steps')
...
parser.add_argument('--num_epochs', type=int, default=100000, 
                    help='# of epochs')  
parser.add_argument('--sample_method', type=str, default="trajectory",
                    help='goal/trajectory')
parser.add_argument('--model_dir', type=str, default=None,
                    help='trained actor and critic')
