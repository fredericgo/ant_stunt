...
from skill_chamfer.sac_chamfer import SACMepol
...
parser.add_argument('--num_workers', type=int, default=1, 
                    help='# of epochs')  
parser.add_argument('--state_filter', type=list, default=list(range(5)),
                    help='state filter')
parser.add_argument('--num_skills', type=int, default=10, 
                    help='# of epochs')  
parser.add_argument('--skill_weight', type=float, default=1e-4, 
                    help='weight of skill in the reward')             
