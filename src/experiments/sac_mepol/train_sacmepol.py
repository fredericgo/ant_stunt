...
from sac_mepol.sac_mepol import SACMepol
...
parser.add_argument('--eval_interval', type=int, default=100, 
                    help='checkpoint training model every # steps')
parser.add_argument('--penalty_weight', type=float, default=1., metavar='G',
                    help='speed penalty(default: 0.0003)')

parser.add_argument('--speed_level', type=float, default=100., metavar='G',
                    help='speed penalty(default: 0.0003)')
...
parser.add_argument('--num_workers', type=int, default=3, 
                    help='# of epochs')  
parser.add_argument('--state_filter', type=list, default=[0, 1, 2, 3, 4, 5, 6], nargs='+',
                    help='state filter')
